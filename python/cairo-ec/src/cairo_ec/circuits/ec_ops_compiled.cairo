...
func ecip_2p{range_check96_ptr: felt*, add_mod_ptr: ModBuiltin*, mul_mod_ptr: ModBuiltin*}(
    ...
    let range_check96_ptr = range_check96_ptr + 1276;
...
func ecip_1p{range_check96_ptr: felt*, add_mod_ptr: ModBuiltin*, mul_mod_ptr: ModBuiltin*}(
    ...
    assert [range_check96_ptr + 112] = x_g.d0;
    assert [range_check96_ptr + 113] = x_g.d1;
    assert [range_check96_ptr + 114] = x_g.d2;
    assert [range_check96_ptr + 115] = x_g.d3;
    assert [range_check96_ptr + 116] = y_g.d0;
    assert [range_check96_ptr + 117] = y_g.d1;
    assert [range_check96_ptr + 118] = y_g.d2;
    assert [range_check96_ptr + 119] = y_g.d3;
    assert [range_check96_ptr + 120] = ep1_low.d0;
    assert [range_check96_ptr + 121] = ep1_low.d1;
    assert [range_check96_ptr + 122] = ep1_low.d2;
    assert [range_check96_ptr + 123] = ep1_low.d3;
    assert [range_check96_ptr + 124] = en1_low.d0;
    assert [range_check96_ptr + 125] = en1_low.d1;
    assert [range_check96_ptr + 126] = en1_low.d2;
    assert [range_check96_ptr + 127] = en1_low.d3;
    assert [range_check96_ptr + 128] = sp1_low.d0;
    assert [range_check96_ptr + 129] = sp1_low.d1;
    assert [range_check96_ptr + 130] = sp1_low.d2;
    assert [range_check96_ptr + 131] = sp1_low.d3;
    assert [range_check96_ptr + 132] = sn1_low.d0;
    assert [range_check96_ptr + 133] = sn1_low.d1;
    assert [range_check96_ptr + 134] = sn1_low.d2;
    assert [range_check96_ptr + 135] = sn1_low.d3;
    assert [range_check96_ptr + 136] = ep1_high.d0;
    assert [range_check96_ptr + 137] = ep1_high.d1;
    assert [range_check96_ptr + 138] = ep1_high.d2;
    assert [range_check96_ptr + 139] = ep1_high.d3;
    assert [range_check96_ptr + 140] = en1_high.d0;
    assert [range_check96_ptr + 141] = en1_high.d1;
    assert [range_check96_ptr + 142] = en1_high.d2;
    assert [range_check96_ptr + 143] = en1_high.d3;
    assert [range_check96_ptr + 144] = sp1_high.d0;
    assert [range_check96_ptr + 145] = sp1_high.d1;
    assert [range_check96_ptr + 146] = sp1_high.d2;
    assert [range_check96_ptr + 147] = sp1_high.d3;
    assert [range_check96_ptr + 148] = sn1_high.d0;
    assert [range_check96_ptr + 149] = sn1_high.d1;
    assert [range_check96_ptr + 150] = sn1_high.d2;
    assert [range_check96_ptr + 151] = sn1_high.d3;
    assert [range_check96_ptr + 152] = x_q_low.d0;
    assert [range_check96_ptr + 153] = x_q_low.d1;
    assert [range_check96_ptr + 154] = x_q_low.d2;
    assert [range_check96_ptr + 155] = x_q_low.d3;
    assert [range_check96_ptr + 156] = y_q_low.d0;
    assert [range_check96_ptr + 157] = y_q_low.d1;
    assert [range_check96_ptr + 158] = y_q_low.d2;
    assert [range_check96_ptr + 159] = y_q_low.d3;
    assert [range_check96_ptr + 160] = x_q_high.d0;
    assert [range_check96_ptr + 161] = x_q_high.d1;
    assert [range_check96_ptr + 162] = x_q_high.d2;
    assert [range_check96_ptr + 163] = x_q_high.d3;
    assert [range_check96_ptr + 164] = y_q_high.d0;
    assert [range_check96_ptr + 165] = y_q_high.d1;
    assert [range_check96_ptr + 166] = y_q_high.d2;
    assert [range_check96_ptr + 167] = y_q_high.d3;
    assert [range_check96_ptr + 168] = x_q_high_shifted.d0;
    assert [range_check96_ptr + 169] = x_q_high_shifted.d1;
    assert [range_check96_ptr + 170] = x_q_high_shifted.d2;
    assert [range_check96_ptr + 171] = x_q_high_shifted.d3;
    assert [range_check96_ptr + 172] = y_q_high_shifted.d0;
    assert [range_check96_ptr + 173] = y_q_high_shifted.d1;
    assert [range_check96_ptr + 174] = y_q_high_shifted.d2;
    assert [range_check96_ptr + 175] = y_q_high_shifted.d3;
    assert [range_check96_ptr + 176] = x_a0.d0;
    assert [range_check96_ptr + 177] = x_a0.d1;
    assert [range_check96_ptr + 178] = x_a0.d2;
    assert [range_check96_ptr + 179] = x_a0.d3;
    assert [range_check96_ptr + 180] = y_a0.d0;
    assert [range_check96_ptr + 181] = y_a0.d1;
    assert [range_check96_ptr + 182] = y_a0.d2;
    assert [range_check96_ptr + 183] = y_a0.d3;
    ...
    let range_check96_ptr = range_check96_ptr + 1040;
