...
namespace Blake2 {
    ...
    func F{pedersen_ptr: HashBuiltin*, range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    ...
    func blake_rounds{pedersen_ptr: HashBuiltin*, range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    ...
    func blake_round{pedersen_ptr: HashBuiltin*, range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    ...
    func mix_one{pedersen_ptr: HashBuiltin*, range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
    ...
    // @return c The new third state word.
    // @return d The new fourth state word.
    func mix_two{pedersen_ptr: HashBuiltin*, range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(
        a: felt, b: felt, c: felt, d: felt, m: felt
    ) -> (a: felt, b: felt, c: felt, d: felt) {
        alloc_locals;
