...
from ethereum.prague.vm.instructions.arithmetic import (
    add,
    mul,
    sub,
    div,
...
from ethereum.prague.vm.instructions.keccak import keccak as keccak_instruction
...
from ethereum.prague.vm.instructions.control_flow import stop, jump, jumpi, pc, gas_left, jumpdest
from ethereum.prague.vm.instructions.storage import sload, sstore, tload, tstore
from ethereum.prague.vm.instructions.stack_instructions import pop
from ethereum.prague.vm.instructions.stack_instructions import (
    push0,
    push1,
    push2,
    push3,
...
from ethereum.prague.vm.instructions.memory_instructions import mstore, mstore8, mload, msize, mcopy
from ethereum.prague.vm.instructions.log import log0, log1, log2, log3, log4
from ethereum.prague.vm.instructions.system import (
    selfdestruct,
    return_,
    revert,
    create,
