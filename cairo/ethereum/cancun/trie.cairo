...
func _get_branch_for_nibble_at_level(obj: MappingBytesBytes, nibble: felt, level: felt) -> (
    ...
    let branch_stop = cast([ap - 2], BytesBytesDictAccess*);
    let branch_start = cast([fp], BytesBytesDictAccess*);
    ...
    tempvar result = MappingBytesBytes(new MappingBytesBytesStruct(branch_start, branch_stop));
    return (result, value);
}
