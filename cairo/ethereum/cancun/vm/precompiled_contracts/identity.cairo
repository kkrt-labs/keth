...
func identity{
    ...
    // Output and data fields are pointers to the same segment. Because `output` is never appended, no risk
    // of a writing to an existing cell of the `output` segment later in the execution.
